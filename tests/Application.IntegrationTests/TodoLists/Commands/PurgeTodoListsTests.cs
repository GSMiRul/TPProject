...
using TPProject.Application.Common.Security;
using TPProject.Application.TodoLists.Commands.CreateTodoList;
using TPProject.Application.TodoLists.Commands.PurgeTodoLists;
using TPProject.Domain.Entities;
using FluentAssertions;
using NUnit.Framework;

namespace TPProject.Application.IntegrationTests.TodoLists.Commands;
